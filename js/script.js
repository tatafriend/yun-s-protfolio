...
function createShapes() {
    const shapes = [
        ...
        Bodies.rectangle(180, 100, 200, 70, { restitution: 0.8, angle: Math.PI / 6, render: { fillStyle: 'transparent', strokeStyle: 'transparent', sprite: { texture: 'https://res.cloudinary.com/dsw8xnof0/image/upload/v1759235876/crayon_figma_yjtvd1.svg', xScale: 0.7, yScale: 0.7 } } }),
         Bodies.rectangle(150, 100, 150, 70, { restitution: 0.8, angle: Math.PI / 6, render: { fillStyle: 'transparent', strokeStyle: 'transparent', sprite: { texture: 'https://res.cloudinary.com/dsw8xnof0/image/upload/v1759242782/crayon_css_vu1uxo.svg', xScale: 0.4, yScale: 0.4 } } }),
         Bodies.rectangle(150, 100, 150, 70, { restitution: 0.8, angle: Math.PI / 6, render: { fillStyle: 'transparent', strokeStyle: 'transparent', sprite: { texture: 'https://res.cloudinary.com/dsw8xnof0/image/upload/v1759244018/crayon_splina_cnsbdf.svg', xScale: 0.5, yScale: 0.5 } } }),
         Bodies.rectangle(150, 100, 150, 70, { restitution: 0.8, angle: Math.PI / 6, render: { fillStyle: 'transparent', strokeStyle: 'transparent', sprite: { texture: 'https://res.cloudinary.com/dsw8xnof0/image/upload/v1759243441/crayon_html_hgl2zt.svg', xScale: 0.4, yScale: 0.4 } } }),
